...
class TenGene1(Env):
    ...
    def step(self, action: Action) -> Tuple[Tuple[int, int, int, int, int, int, int, int, int, int, np.float64, np.float64, np.float64, np.float64, np.float64, np.float64, np.float64, np.float64, np.float64, np.float64], float, bool, dict]:
        ...
        model_choice = np.random.choice(np.arange(self.modelNum), 1, p=model_probs) # 222 #np.random.choice(np.arange(self.modelNum), 1, p=model_probs) #222 #np.random.choice(np.arange(self.modelNum), 1, p=model_probs) #222 #242#np.random.choice(np.arange(self.modelNum), 1, p=model_probs)#int((self.agent_pos)[7])#np.random.choice(np.arange(self.modelNum), 1, p=model_probs)
